<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:57:"/alidata/www/loan/application/index/view/user/addCar.html";i:1528343046;s:57:"/alidata/www/loan/application/index/view/common/head.html";i:1521180510;s:59:"/alidata/www/loan/application/index/view/common/footer.html";i:1528860026;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="layui-form layui-form-pane" method="post" >
        <div class="layui-form-item">
            ...
            <div class="layui-input-4">
                <input type="text" name="plate" lay-verify="required" placeholder="车牌号" class="layui-input" value="">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-4">
                <input type="text" name="pingpai" placeholder="品牌" lay-verify="required" class="layui-input" value="">
            </div>
            <div class="layui-form-mid layui-word-aux red">*</div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-4">
                <input type="text" name="xinghao" placeholder="型号" lay-verify="required" class="layui-input" value="">
            </div>
            <div class="layui-form-mid layui-word-aux red">*</div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-2" id="ime">
                <input type="text" name="ime[]" placeholder="IME" lay-verify="required" class="layui-input" value="">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-4">
                <input type="text" name="chejia" placeholder="车架号" lay-verify="required" class="layui-input" value="">
            </div>
            <div class="layui-form-mid layui-word-aux red">*</div>
        </div>
        <div class="layui-form-item">
...
<script>
    ...
    layui.use(['form','upload','layer'], function () {
        ...
        form.on('submit(submit)', function (data) {
            ...
            $.post('<?php echo url("User/addCar"); ?>',fields, function (res) {
                layer.close(loading);
                if (res.code > 0) {
